    ...
    <div class="hand-height-2 shadow-hvover">
      ...
      <div class="card-body pt-0 overflow-scroll h-100 ">
        <KTDatatable @on-items-select="onItemSelect" :data="list" :header="headerConfig" :loading="loading"
          ...
          <template v-slot:group_name="{ row: customer }">{{ customer.group_name ?? '--' }}</template>
          ...
          <template v-slot:username="{ row: customer }">
            <div class="d-flex align-items-center">
              ...
              <div class="d-flex flex-column">
                <a href="#" class="text-dark  text-hover-primary fs-6 fw-bold">{{customer.username ?? '--' }}</a>
            ...
            <div class="card card-flush pt-3 mb-5 mb-xl-10">
                ...
                <div class="card-header">
                  ...
                  <div class="card-title">
                    <h1 class="fw-bold">{{ detailData.group_name ?? '--' }}</h1>
                  </div>
                  <!--begin::Card toolbar-->
                      ...
                      <div class="flex-equal me-5">
                        ...
                        <table class="table fs-6 fw-semobold gs-0 gy-2 gx-2 m-0">
                          ...
                          <tr>
                            ...
                            <td class="text-gray-800">{{ detailData.username ?? '--' }}</td>
                          </tr>
                          <!--end::Row-->

                          <!--begin::Row-->
                          <tr>
                            <td class="text-gray-400">SDT:</td>
                            <td class="text-gray-800 badge badge-light pe-2">{{ detailData.phone ?? '--' }} </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <tr>
                            ...
                            <td class="text-gray-800  badge badge-light pe-2" >{{ detailData.text ?? '--' }}</td>
                          </tr>
                          <!--end::Row-->

                          <!--begin::Row-->
                            <tr>
                            <td class="text-gray-400">Thời gian :</td>
