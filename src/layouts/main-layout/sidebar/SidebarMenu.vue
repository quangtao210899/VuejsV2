...
export default defineComponent({
  ...
  setup() {
    ...
    const checkActive = (menuItem: String, routeName: any) => {
      ...
      if (menuItem == '/target-list' && ['target-scan','target-recon','target-scanstab','target-recon-tab','target-recon-tab-subdomains','target-form', 'target-detail', 'target-recon-add'].includes(routeName) ) {
        return true;
      }
      return false
    }
